 ...
 */
type BunCollectOptions = Pick<NonNullable<NodeRuntimeMetricsOptions['collect']>, 'cpuUtilization' | 'cpuTime' | 'memHeapUsed' | 'memHeapTotal' | 'memRss' | 'memExternal' | 'eventLoopUtilization' | 'uptime'>;
 ...
 * ```
 */
export declare const bunRuntimeMetricsIntegration: (options?: BunRuntimeMetricsOptions | undefined) => import("@sentry/core").Integration;
export {};
//# sourceMappingURL=bunRuntimeMetrics.d.ts.map