  ...
  function attemptEarlyBailoutIfNoScheduledUpdate(
    ...
    switch (workInProgress.tag) {
      ...
      case 31:
        ...
        break;
      case 13:
        var state$88 = workInProgress.memoizedState;
        if (null !== state$88) {
          if (null !== state$88.dehydrated)
            return (
              pushPrimaryTreeSuspenseHandler(workInProgress),
              (workInProgress.flags |= 128),
              null
            );
          state$88 = propagateParentContextChanges(
            current,
            workInProgress,
            renderLanes,
            !1
          ...
          if (state$88 || 0 !== (renderLanes & primaryChildLanes))
      ...
      case 19:
        ...
        state$88 = 0 !== (renderLanes & workInProgress.childLanes);
        state$88 ||
          (propagateParentContextChanges(
            current,
            workInProgress,
      ...
      if (
        ...
        oldProps$94 === currentInstance
          ...
          : (markCloned(workInProgress),
            ...
            current && appendAllChildren(oldProps$94, workInProgress, !1, !1));
    ...
    if (didBailout)
      for (var child$97 = completedWork.child; null !== child$97; )
        (newChildLanes |= child$97.lanes | child$97.childLanes),
          (subtreeFlags |= child$97.subtreeFlags & 133169152),
          (subtreeFlags |= child$97.flags & 133169152),
      ...
      case 5:
        ...
        if (null !== current && null != workInProgress.stateNode)
          ...
          if (popHydrationState(workInProgress))
            ...
            var instance$107 = createInstance(
              type,
              newProps,
              rootInstanceStackCursor.current,
              nextResource,
            ...
            markCloned(workInProgress);
            appendAllChildren(instance$107, workInProgress, !1, !1);
            workInProgress.stateNode = instance$107;
            finalizeInitialChildren(
              instance$107,
              type,
              newProps,
    ...
    switch (finishedWork.tag) {
      ...
      case 6:
        ...
        if (flags & 4 && supportsMutation) {
          ...
          try {
            commitTextUpdate(lanes, current, root),
              (viewTransitionMutationContext = !0);
          } catch (error) {
            captureCommitPhaseError(finishedWork, finishedWork.return, error);
          }
      ...
      case 3:
        ...
        if (flags & 4) {
          ...
          if (supportsPersistence) {
            ...
            try {
              replaceContainerChildren(current, flags),
                (viewTransitionMutationContext = !0);
            } catch (error) {
              captureCommitPhaseError(finishedWork, finishedWork.return, error);
            }
      ...
      case 4:
        ...
        if (supportsResources) {
          var previousHoistableRoot$145 = currentHoistableRoot;
          currentHoistableRoot = getHoistableRoot(
            finishedWork.stateNode.containerInfo
          );
          recursivelyTraverseMutationEffects(root, finishedWork, lanes);
          commitReconciliationEffects(finishedWork);
          currentHoistableRoot = previousHoistableRoot$145;
        } else
          recursivelyTraverseMutationEffects(root, finishedWork, lanes),
            commitReconciliationEffects(finishedWork);
      ...
      case 22:
        ...
        offscreenDirectParentIsHidden =
          prevOffscreenDirectParentIsHidden$147 || hoistableRoot;
        offscreenSubtreeWasHidden =
          prevOffscreenSubtreeWasHidden || previousHoistableRoot$145;
        recursivelyTraverseMutationEffects(root, finishedWork, lanes);
        offscreenSubtreeWasHidden = prevOffscreenSubtreeWasHidden;
      ...
      case 30:
        ...
        previousHoistableRoot$145 = (lanes & 335544064) === lanes;
      ...
      try {
        ...
        if (supportsMutation) {
          ...
          switch (hostParentFiber.tag) {
            ...
            case 5:
              var parent$133 = hostParentFiber.stateNode;
              hostParentFiber.flags & 32 &&
                (resetTextContent(parent$133), (hostParentFiber.flags &= -33));
      ...
      switch (parentFiber.tag) {
        case 5:
          ...
          switch (visitPhase) {
            ...
            case 3:
              var nextPhase =
                0 !== (parentFiber.subtreeFlags & 18874368) ? 3 : 4;
              break;
            default:
              nextPhase = 4;
          }
        ...
        case 6:
          ...
          if (1 === visitPhase || 2 === visitPhase)
            unhideTextInstance(nextPhase, parentFiber.memoizedProps),
              (viewTransitionMutationContext = !0);
          break;
        case 4:
          break;
  ...
  function recursivelyInsertClones(
    ...
    if (
      ...
      for (parentFiber = parentFiber.child; null !== parentFiber; ) {
        deletions = parentFiber;
        i = hostParentClone;
        var nextPhase$164 = parentViewTransition;
        var visitPhase = visitPhase$jscomp$0;
        var nextPhase = deletions.alternate;
        if (null === nextPhase)
          recursivelyInsertNewFiber(deletions, i, nextPhase$164, 5);
        else {
          ...
          switch (deletions.tag) {
            ...
            case 5:
              ...
              null !== nextPhase$164 &&
                (null === nextPhase$164.clones
                  ? (nextPhase$164.clones = [clone])
                  : nextPhase$164.clones.push(clone));
              break;
            case 6:
              nextPhase$164 = deletions.stateNode;
              if (null === nextPhase$164)
                throw Error(formatProdErrorMessage(162));
              nextPhase$164 = cloneMutableTextInstance(nextPhase$164);
              flags & 4 &&
                (commitTextUpdate(
                  nextPhase$164,
                  deletions.memoizedProps,
                ...
                (viewTransitionMutationContext = !0));
              appendChild(i, nextPhase$164);
              if (1 === visitPhase || 2 === visitPhase)
                unhideTextInstance(nextPhase$164, deletions.memoizedProps),
                  (viewTransitionMutationContext = !0);
              break;
            case 4:
              break;
            case 22:
              null === deletions.memoizedState
                ? ((nextPhase =
                    0 === visitPhase && 0 !== (flags & 8192) ? 1 : visitPhase),
                  recursivelyInsertClones(
                    deletions,
                    i,
                    nextPhase$164,
            ...
            case 30:
              ...
              clone.clones = null;
              nextPhase$164 = 1 === visitPhase ? 2 : visitPhase;
              recursivelyInsertClones(deletions, i, clone, nextPhase$164);
              ...
              break;
            default:
              recursivelyInsertClones(deletions, i, nextPhase$164, visitPhase);
          }
        }
        parentFiber = parentFiber.sibling;
      }
        ...
        if (null === suspendedCommitReason.running) {
          ...
          if (null === finishedGesture) ensureRootIsScheduled(root);
            ...
            try {
              ...
              recursivelyInsertClones(finishedWork, rootClone, null, 0);
            } finally {
              (executionContext = prevExecutionContext),
                setCurrentUpdatePriority(previousPriority),
                (ReactSharedInternals.T = prevTransition);
