...
module.exports = function ($$$config) {
      ...
      if (
        ...
        oldProps$104 === currentInstance
          ...
          : (markCloned(workInProgress),
            ...
            current && appendAllChildren(oldProps$104, workInProgress, !1, !1));
      ...
      if (0 !== (completedWork.mode & 2)) {
        for (
          ...
          (newChildLanes |= child$109.lanes | child$109.childLanes),
            (subtreeFlags |= child$109.subtreeFlags & 133169152),
            (subtreeFlags |= child$109.flags & 133169152),
        ...
        for (
          ...
          (newChildLanes |=
            ...
            (subtreeFlags |= treeBaseDuration$108.subtreeFlags & 133169152),
            (subtreeFlags |= treeBaseDuration$108.flags & 133169152),
      ...
      case 5:
        ...
        if (null !== current && null != workInProgress.stateNode)
          ...
          if (popHydrationState(workInProgress))
            ...
            var instance$124 = createInstance(
              type,
              newProps,
              rootInstanceStackCursor.current,
              nextResource,
            ...
            markCloned(workInProgress);
            appendAllChildren(instance$124, workInProgress, !1, !1);
            workInProgress.stateNode = instance$124;
            finalizeInitialChildren(
              instance$124,
              type,
              newProps,
    ...
    switch (finishedWork.tag) {
      ...
      case 6:
        ...
        if (flags & 4 && supportsMutation) {
          ...
          try {
            commitTextUpdate(current, lanes, root),
              (viewTransitionMutationContext = !0);
          } catch (error) {
            captureCommitPhaseError(finishedWork, finishedWork.return, error);
          }
          ...
          switch (hostParentFiber.tag) {
            ...
            case 5:
              ...
              hostParentFiber.flags & 32 &&
                (resetTextContent(parent$153), (hostParentFiber.flags &= -33));
  ...
  function recursivelyInsertClones(
    ...
    if (
      ...
      for (parentFiber = parentFiber.child; null !== parentFiber; ) {
        deletions = parentFiber;
        i = hostParentClone;
        var nextPhase$201 = parentViewTransition;
        var visitPhase = visitPhase$jscomp$0;
        var nextPhase = deletions.alternate;
        if (null === nextPhase)
          recursivelyInsertNewFiber(deletions, i, nextPhase$201, 5);
        else {
          ...
          switch (deletions.tag) {
            ...
            case 5:
              ...
              null !== nextPhase$201 &&
                (null === nextPhase$201.clones
                  ? (nextPhase$201.clones = [clone])
                  : nextPhase$201.clones.push(clone));
              break;
            case 6:
              nextPhase$201 = deletions.stateNode;
              if (null === nextPhase$201)
                throw Error(formatProdErrorMessage(162));
              nextPhase$201 = cloneMutableTextInstance(nextPhase$201);
              flags & 4 &&
                (commitTextUpdate(
                  nextPhase$201,
                  deletions.memoizedProps,
                ...
                (viewTransitionMutationContext = !0));
              appendChild(i, nextPhase$201);
              if (1 === visitPhase || 2 === visitPhase)
                unhideTextInstance(nextPhase$201, deletions.memoizedProps),
                  (viewTransitionMutationContext = !0);
              break;
            case 4:
              break;
            ...
            case 30:
              ...
              clone.clones = null;
              nextPhase$201 = 1 === visitPhase ? 2 : visitPhase;
              recursivelyInsertClones(deletions, i, clone, nextPhase$201);
              ...
              break;
            default:
              recursivelyInsertClones(deletions, i, nextPhase$201, visitPhase);
          }
        }
        parentFiber = parentFiber.sibling;
      }
  ...
  exports.createHydrationContainer = function (
    ...
    startUpdateTimerByLane(containerInfo);
